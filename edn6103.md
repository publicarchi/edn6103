...
Chateau Dutier Emmanuel vous invite à une réunion Zoom planifiée.
...
- Retours sur TP Persée
- Ontologies et vocabulaires structurés : SKOSS et RDFs
- ex RDFs
- Ontologies OWL
- ex Friend of Friend
- Le protocole et le langage de requête SPARQL
- Rappels sur la notation RDF et notation SPARQL
- ex Écritures de requêtes avec SPARQL dans Persée
- TP Écriture de requêtes SPARQL  (typologie de requêtes sur projets au choix)
