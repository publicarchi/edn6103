...
.footnote[Deux concepts de Rameau représentés sous forme de graphe RDF/SKOS]
...
- Naviguer dans le thesaurus de désignation architecturale du ministère de la Culture et de la communication en France 
  http://data.culture.fr/thesaurus/
- Télécharger le vocabulaire au format SKOS
- Prendre connaissance du fichier, de sa structure, identifier les liens internes et externes
- Visualiser le fichier dans SKOS Play
...
- #### ORDER BY, LIMIT, OFFSET – pour limiter l’ensemble résultat comme dans SQL
