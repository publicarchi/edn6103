...
Avec Dublin Core, vous avez déjà eu l’occasion de voir ce que permet l’approche d’un premier modèle minimal.

- comprendre ce qu’est un modèle descriptif
- indentifier en pratique la notion de format
...
- Onix
- modèles bibliographiques tels que Bibframe, etc.
...
Projet porté par le fondateur du www depuis de nombreuses années.
...
- **Outil de conversion web ou en ligne de commande [EasyRDF](http://www.easyrdf.org/converter)**
